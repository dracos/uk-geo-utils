...
from uk_geo_utils.management.commands.clean_addressbase_standard import Command
...
class CleanAddressesTest(TestCase):
    def test_clean_addresses_valid(self):
        ...
        expected_outfile = os.path.abspath(
            os.path.join(
                os.path.dirname(os.path.abspath(__file__)),
                "../fixtures/addressbase_standard/addressbase_cleaned.csv",
            )
        )
